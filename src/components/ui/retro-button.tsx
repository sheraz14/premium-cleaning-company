...
const retroButtonVariants = cva(
  "relative inline-flex items-center justify-center w-24 rounded-[2px] shadow-[1px_1px_1px_rgba(255,255,255,0.6)]",
  {
    variants: {
      variant: {
        default: [
        ...
        white: [
          ...
          "[--bg-color-active:theme(colors.purple.50)]",
          "[--shadow-light:theme(colors.white)]",
          "[--shadow-dark:theme(colors.purple.200)]",
        ],
        lightGray: [
          "text-white",
        ...
        purple: [
          ...
          "[--bg-color-active:theme(colors.purple.800)]",
          "[--shadow-light:theme(colors.purple.400)]",
          "[--shadow-dark:theme(colors.purple.900)]",
        ],
      },
    },
    defaultVariants: {
