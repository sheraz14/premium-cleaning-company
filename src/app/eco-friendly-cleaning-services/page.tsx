...
export default function EcoFriendlyCleaningPage() {
  ...
  const features = [
    { icon: <Leaf className="h-5 w-5 text-green-500" />, label: "Certified Green Products" },
    { icon: <Sparkles className="h-5 w-5 text-emerald-500" />, label: "Non-Toxic Solutions" },
  ...
  return (
    <main className="min-h-screen">
        ...
        <div className="w-full max-w-full md:max-w-xl flex flex-col items-center w-full px-2 md:px-4 py-8 md:py-12 z-10 -mt-20 md:-mt-30">
          <div className="mb-6 flex flex-col items-center w-full">
            ...
            <h1 className="text-2xl sm:text-3xl md:text-5xl font-extrabold bg-gradient-to-r from-green-700 via-emerald-700 to-lime-600 bg-clip-text text-transparent mb-2 text-center drop-shadow-lg w-full">
              Get Your Eco-Friendly Cleaning Quote
            </h1>
            <p className="text-base sm:text-lg text-muted-foreground mb-2 text-center font-medium w-full">
              Experience a healthier, greener clean with <span className="font-bold bg-gradient-to-r from-green-700 via-emerald-700 to-lime-600 bg-clip-text text-transparent">Dust Drifters</span>—premium eco-friendly cleaning for homes and businesses!
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-3 w-full bg-white/70 backdrop-blur-md rounded-2xl p-4 md:p-8 shadow-2xl border border-white/60">
            ...
            {/* Cleaning type is fixed to Eco-Friendly Cleaning for this page */}
      ...
      <section>
        <CTA />
        {/* Why Invest in Eco-Friendly Cleaning? Section */}
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-10">
              <div className="inline-flex items-center px-4 py-2 rounded-full bg-green-100/90 backdrop-blur-sm text-green-800 shadow-md mb-4 justify-center">
                ...
                <span className="text-base font-medium">Why Go Green?</span>
              </div>
              <h3 className="text-3xl md:text-4xl font-bold mb-4 bg-gradient-to-r from-green-700 via-emerald-700 to-lime-600 bg-clip-text text-transparent">
                Why Invest in Eco-Friendly Cleaning?
              </h3>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
              <div className="flex flex-col items-center text-center p-6 rounded-xl hover:bg-green-50/60 transition-all duration-300 hover:shadow-md">
                ...
                <h4 className="text-xl font-semibold text-green-800 mb-3">Healthier Spaces</h4>
                <p className="text-green-900/80">Our non-toxic products reduce allergens and chemical exposure, making your home or office safer for everyone.</p>
              </div>
              <div className="flex flex-col items-center text-center p-6 rounded-xl hover:bg-green-50/60 transition-all duration-300 hover:shadow-md">
                <div className="bg-green-100 p-4 rounded-full mb-4">
                  <Leaf className="h-8 w-8 text-green-600" />
                </div>
                <h4 className="text-xl font-semibold text-green-800 mb-3">Planet-Friendly</h4>
                <p className="text-green-900/80">We use biodegradable, plant-based products and sustainable methods to minimize our environmental impact.</p>
              </div>
              <div className="flex flex-col items-center text-center p-6 rounded-xl hover:bg-green-50/60 transition-all duration-300 hover:shadow-md">
                <div className="bg-green-100 p-4 rounded-full mb-4">
                  <ShieldCheck className="h-8 w-8 text-green-600" />
                </div>
                <h4 className="text-xl font-semibold text-green-800 mb-3">Just as Effective</h4>
                <p className="text-green-900/80">Our green cleaning delivers the same sparkling results—without harsh chemicals or lingering odors.</p>
              </div>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="flex flex-col items-center text-center p-6 rounded-xl hover:bg-green-50/60 transition-all duration-300 hover:shadow-md">
                ...
                <h4 className="text-xl font-semibold text-green-800 mb-3">Safe for Families & Pets</h4>
                <p className="text-green-900/80">No toxic residues—just a clean, healthy environment for your loved ones and furry friends.</p>
              </div>
              <div className="flex flex-col items-center text-center p-6 rounded-xl hover:bg-green-50/60 transition-all duration-300 hover:shadow-md">
                <div className="bg-green-100 p-4 rounded-full mb-4">
                ...
                <p className="text-green-900/80">Book at your convenience—our eco-friendly team works around your schedule.</p>
              </div>
            </div>
          </div>
        </section>
