...
import { Building2, Sparkles, ShieldCheck, Leaf, Users, CalendarCheck2, Star } from "lucide-react";
...
export default function CondoCleaningPage() {
  ...
  return (
    <main className="min-h-screen">
      ...
      <section className="relative w-full h-auto min-h-[600px] flex overflow-hidden pt-12 md:pt-20 pb-0 md:py-0">
        ...
        <div className="w-full max-w-full md:max-w-xl flex flex-col items-center w-full px-2 md:px-4 py-8 md:py-12 z-10 -mt-20 md:-mt-30">
          ...
          <div className="mb-6 flex flex-col items-center w-full">
            <span className="inline-flex items-center gap-2 text-purple-700 font-semibold text-sm md:text-base mb-2">
              <Building2 className="h-5 w-5 text-purple-500" />
              Specialized Condo & Apartment Cleaning
            </span>
            <h1 className="text-2xl sm:text-3xl md:text-5xl font-extrabold bg-gradient-to-r from-purple-700 via-pink-700 to-emerald-600 bg-clip-text text-transparent mb-2 text-center drop-shadow-lg w-full">
              Get Your Free Condo/Apartment Cleaning Quote
            </h1>
            <p className="text-base sm:text-lg text-muted-foreground mb-2 text-center font-medium w-full">
              Book today and enjoy a sparkling clean condo or apartment with <span className="font-bold bg-gradient-to-r from-purple-700 via-pink-700 to-emerald-600 bg-clip-text text-transparent">Dust Drifters</span>! We respect your neighbors and deliver exceptional results in multi-unit buildings.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-3 w-full bg-white/70 backdrop-blur-md rounded-2xl p-4 md:p-8 shadow-2xl border border-white/60">
            ...
            {/* Cleaning type is fixed to Condo and Apartment Cleaning for this page */}
            <select name="cleaning" value={form.cleaning} onChange={handleChange} required className="rounded-lg border border-slate-200 px-4 py-2 focus:ring-2 focus:ring-primary focus:border-primary transition text-gray-700 bg-white/80 w-full" disabled>
              <option value="condo">Condo/Apartment Cleaning</option>
            </select>
            <div className="flex flex-col md:flex-row gap-3 w-full">
            ...
            <Button type="submit" size="lg" className="mt-2 w-full bg-gradient-to-r from-purple-500 via-pink-500 to-emerald-400 text-white font-bold shadow-lg hover:scale-105 hover:shadow-xl transition-transform duration-200" disabled={submitting}>
              {submitting ? "Sending..." : "Get My Price"}
              <span className="ml-2"><Building2 className="w-5 h-5" /></span>
            </Button>
          </form>
          ...
          <div className="mt-6 flex flex-col items-center justify-center gap-2 w-full">
            ...
            <span className="text-sm text-muted-foreground font-medium mt-1">Trusted by 100+ happy condo & apartment clients</span>
          </div>
        </div>
      ...
      {/* CTA banner section */}
      <CTA />
      {/* Why Invest in Professional Condo and Apartment Cleaning? Section */}
      <section className="w-full py-16 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-10">
            <div className="inline-flex items-center px-4 py-2 rounded-full bg-purple-100/90 backdrop-blur-sm text-purple-800 shadow-md mb-4 justify-center">
            ...
            <h3 className="text-3xl md:text-4xl font-bold mb-4 bg-gradient-to-r from-purple-700 via-pink-700 to-emerald-600 bg-clip-text text-transparent">
              Why Invest in Professional Condo and Apartment Cleaning?
            </h3>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            <div className="flex flex-col items-center text-center p-6 rounded-xl hover:bg-purple-50/60 transition-all duration-300 hover:shadow-md">
              ...
              <p className="text-purple-900/80">Enjoy your condo and spend more time on what matters while we handle the cleaning chores for you.</p>
            </div>
            <div className="flex flex-col items-center text-center p-6 rounded-xl hover:bg-purple-50/60 transition-all duration-300 hover:shadow-md">
              <div className="bg-purple-100 p-4 rounded-full mb-4">
              ...
              <p className="text-purple-900/80">Our thorough cleaning reduces allergens, dust, and germs, creating a healthier environment in your condo or apartment.</p>
            </div>
            <div className="flex flex-col items-center text-center p-6 rounded-xl hover:bg-purple-50/60 transition-all duration-300 hover:shadow-md">
              <div className="bg-purple-100 p-4 rounded-full mb-4">
                <Star className="h-8 w-8 text-purple-600" />
              </div>
              <h4 className="text-xl font-semibold text-purple-800 mb-3">A Space to Be Proud Of</h4>
              <p className="text-purple-900/80">A spotless condo is welcoming for guests and gives you peace of mind every day.</p>
            </div>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="flex flex-col items-center text-center p-6 rounded-xl hover:bg-purple-50/60 transition-all duration-300 hover:shadow-md">
              ...
              <p className="text-purple-900/80">Let us handle the cleaning so you can focus on your work, hobbies, or relaxation.</p>
            </div>
            <div className="flex flex-col items-center text-center p-6 rounded-xl hover:bg-purple-50/60 transition-all duration-300 hover:shadow-md">
              <div className="bg-purple-100 p-4 rounded-full mb-4">
              ...
              <p className="text-purple-900/80">We work around your building's rules and your schedule to keep your condo clean when it's most convenient for you.</p>
            </div>
          </div>
        </div>
      </section>
